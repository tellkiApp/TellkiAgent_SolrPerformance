 ...
 */
var metrics = [];
metrics.push({ id: '1711:Committed Virtual Memory Size:4',  type: 'system', value : function(o) { return (o.system.committedVirtualMemorySize / 1024 / 1024).toFixed(2); } });
metrics.push({ id: '1712:Free Physical Memory Size:4',      type: 'system', value : function(o) { return (o.system.freePhysicalMemorySize  / 1024 / 1024).toFixed(2); } });
metrics.push({ id: '1713:Process CPU Time:4',               type: 'system', value : function(o) { return (o.system.processCpuTime / 1000000000).toFixed(2); } });
metrics.push({ id: '1714:Open File Descriptor Count:4',     type: 'system', value : function(o) { return o.system.openFileDescriptorCount; } });
metrics.push({ id: '1715:Max File Descriptor Count:4',      type: 'system', value : function(o) { return o.system.maxFileDescriptorCount; } });
metrics.push({ id: '1716:Uptime:4',                         type: 'system', value : function(o) { return (o.jvm.jmx.upTimeMS / 1000 / 60 / 60).toFixed(2); } });
metrics.push({ id: '1717:Processors:4',                     type: 'system', value : function(o) { return o.jvm.processors; } });
metrics.push({ id: '1718:Memory Free:4',                    type: 'system', value : function(o) { return (o.jvm.memory.raw.free  / 1024 / 1024).toFixed(2); } });
metrics.push({ id: '1719:Memory Total:4',                   type: 'system', value : function(o) { return (o.jvm.memory.raw.total  / 1024 / 1024).toFixed(2); } });
metrics.push({ id: '1720:Memory Max:4',                     type: 'system', value : function(o) { return (o.jvm.memory.raw.max  / 1024 / 1024).toFixed(2); } });
metrics.push({ id: '1721:Memory Used:4',                    type: 'system', value : function(o) { return (o.jvm.memory.raw.used  / 1024 / 1024).toFixed(2); } });
metrics.push({ id: '1722:Thread Count Current:4', type: 'threads', value : function(o) { return o.system.threadCount.current; } });
metrics.push({ id: '1723:Thread Count Peak:4',    type: 'threads', value : function(o) { return o.system.threadCount.peak; } });
metrics.push({ id: '1724:Thread Count Daemon:4',  type: 'threads', value : function(o) { return o.system.threadCount.daemon; } });
metrics.push({ id: '1725:Cache Stats Lookups:4',      type: 'mbeans', value : function(o) { return o['solr-mbeans'].CACHE.documentCache.stats.lookups; } });
metrics.push({ id: '1726:Cache Stats Hits:4',         type: 'mbeans', value : function(o) { return o['solr-mbeans'].CACHE.documentCache.stats.hits; } });
metrics.push({ id: '1727:Cache Stats Hit Ratio:4',    type: 'mbeans', value : function(o) { return o['solr-mbeans'].CACHE.documentCache.stats.hitratio; } });
metrics.push({ id: '1728:Cache Stats Inserts:4',      type: 'mbeans', value : function(o) { return o['solr-mbeans'].CACHE.documentCache.stats.inserts; } });
metrics.push({ id: '1729:Cache Stats Size:4',         type: 'mbeans', value : function(o) { return o['solr-mbeans'].CACHE.documentCache.stats.size; } });
metrics.push({ id: '1730:Cache Stats Evictions:4',    type: 'mbeans', value : function(o) { return o['solr-mbeans'].CACHE.documentCache.stats.evictions; } });
metrics.push({ id: '1731:Cache Stats Warmup Time:4',  type: 'mbeans', value : function(o) { return o['solr-mbeans'].CACHE.documentCache.stats.warmupTime; } });
